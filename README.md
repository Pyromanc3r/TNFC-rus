...
**/hqm edit**
- выдает специальную квестовую книгу для операторов. В ней можно мгновенно завершать и откатывать квесты при нажатии Shift+ЛКМ по иконке квеста. **На случай, если забагуется какой-нибудь квест**.
...
Также, ошибки можете присылать на почту, если у вас нет аккаунта на гитхабе
1710-perevod@bk.ru
